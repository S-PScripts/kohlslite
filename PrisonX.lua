        	...
        	if LocalPlayer.Character then
				if LocalPlayer.Character.HumanoidRootPart then
					if LocalPlayer.Character.HumanoidRootPart.Position.Y < -7 then
                    	LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(LocalPlayer.Character.HumanoidRootPart.Position.X,150,LocalPlayer.Character.HumanoidRootPart.Position.Z)
